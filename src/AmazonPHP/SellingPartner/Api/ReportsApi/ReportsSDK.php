...
final class ReportsSDK implements ReportsSDKInterface
{
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function createReport(AccessToken $accessToken, string $region, $body) : \AmazonPHP\SellingPartner\Model\Reports\CreateReportResponse
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function createReportSchedule(AccessToken $accessToken, string $region, $body) : \AmazonPHP\SellingPartner\Model\Reports\CreateReportScheduleResponse
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getReport(AccessToken $accessToken, string $region, $report_id) : \AmazonPHP\SellingPartner\Model\Reports\Report
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getReportDocument(AccessToken $accessToken, string $region, $report_document_id) : \AmazonPHP\SellingPartner\Model\Reports\ReportDocument
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getReportSchedule(AccessToken $accessToken, string $region, $report_schedule_id) : \AmazonPHP\SellingPartner\Model\Reports\ReportSchedule
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getReportSchedules(AccessToken $accessToken, string $region, $report_types) : \AmazonPHP\SellingPartner\Model\Reports\ReportScheduleList
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getReports(AccessToken $accessToken, string $region, $report_types = null, $processing_statuses = null, $marketplace_ids = null, $page_size = 10, \DateTimeInterface $created_since = null, \DateTimeInterface $created_until = null, $next_token = null) : \AmazonPHP\SellingPartner\Model\Reports\GetReportsResponse
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getReportsRequest(AccessToken $accessToken, string $region, $report_types = null, $processing_statuses = null, $marketplace_ids = null, $page_size = 10, \DateTimeInterface $created_since = null, \DateTimeInterface $created_until = null, $next_token = null) : RequestInterface
    {
