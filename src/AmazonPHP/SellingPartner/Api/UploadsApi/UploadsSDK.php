...
interface UploadsSDKInterface
{
     ...
     */
    public function createUploadDestinationForResource(AccessToken $accessToken, string $region, array $marketplace_ids, string $content_md5, string $resource, string $content_type = null);
...
final class UploadsSDK implements UploadsSDKInterface
{
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function createUploadDestinationForResource(AccessToken $accessToken, string $region, $marketplace_ids, $content_md5, $resource, $content_type = null) : \AmazonPHP\SellingPartner\Model\Uploads\CreateUploadDestinationResponse
    {
