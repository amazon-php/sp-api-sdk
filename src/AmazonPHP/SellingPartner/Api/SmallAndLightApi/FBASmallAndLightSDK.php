...
final class FBASmallAndLightSDK implements FBASmallAndLightSDKInterface
{
     ...
     */
    public function deleteSmallAndLightEnrollmentBySellerSKU(AccessToken $accessToken, string $region, $seller_sku, $marketplace_ids)
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function deleteSmallAndLightEnrollmentBySellerSKURequest(AccessToken $accessToken, string $region, $seller_sku, $marketplace_ids) : RequestInterface
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getSmallAndLightEligibilityBySellerSKU(AccessToken $accessToken, string $region, $seller_sku, $marketplace_ids) : \AmazonPHP\SellingPartner\Model\FBASmallAndLight\SmallAndLightEligibility
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getSmallAndLightEligibilityBySellerSKURequest(AccessToken $accessToken, string $region, $seller_sku, $marketplace_ids) : RequestInterface
    {
        // verify the required parameter 'seller_sku' is set
        if ($seller_sku === null || (\is_array($seller_sku) && \count($seller_sku) === 0)) {
            throw new InvalidArgumentException(
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getSmallAndLightEnrollmentBySellerSKU(AccessToken $accessToken, string $region, $seller_sku, $marketplace_ids) : \AmazonPHP\SellingPartner\Model\FBASmallAndLight\SmallAndLightEnrollment
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getSmallAndLightEnrollmentBySellerSKURequest(AccessToken $accessToken, string $region, $seller_sku, $marketplace_ids) : RequestInterface
    {
        // verify the required parameter 'seller_sku' is set
        if ($seller_sku === null || (\is_array($seller_sku) && \count($seller_sku) === 0)) {
            throw new InvalidArgumentException(
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getSmallAndLightFeePreview(AccessToken $accessToken, string $region, $body) : \AmazonPHP\SellingPartner\Model\FBASmallAndLight\SmallAndLightFeePreviews
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getSmallAndLightFeePreviewRequest(AccessToken $accessToken, string $region, $body) : RequestInterface
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function putSmallAndLightEnrollmentBySellerSKU(AccessToken $accessToken, string $region, $seller_sku, $marketplace_ids) : \AmazonPHP\SellingPartner\Model\FBASmallAndLight\SmallAndLightEnrollment
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function putSmallAndLightEnrollmentBySellerSKURequest(AccessToken $accessToken, string $region, $seller_sku, $marketplace_ids) : RequestInterface
    {
        // verify the required parameter 'seller_sku' is set
        if ($seller_sku === null || (\is_array($seller_sku) && \count($seller_sku) === 0)) {
            throw new InvalidArgumentException(
