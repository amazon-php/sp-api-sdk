...
final class OrdersSDK implements OrdersSDKInterface
{
     ...
     * @return null
     */
    public function confirmShipment(AccessToken $accessToken, string $region, $order_id, $payload)
    {
     ...
     */
    public function getOrder(AccessToken $accessToken, string $region, $order_id)
    {
     ...
     */
    public function getOrderAddress(AccessToken $accessToken, string $region, $order_id)
    {
     ...
     */
    public function getOrderBuyerInfo(AccessToken $accessToken, string $region, $order_id)
    {
     ...
     */
    public function getOrderItems(AccessToken $accessToken, string $region, $order_id, $next_token = null)
    {
     ...
     */
    public function getOrderItemsBuyerInfo(AccessToken $accessToken, string $region, $order_id, $next_token = null)
    {
     ...
     */
    public function getOrderRegulatedInfo(AccessToken $accessToken, string $region, $order_id)
    {
     ...
     * @param string|null $created_after  A date used for selecting orders created after (or at) a specified time. Only orders placed after the specified time are returned. Either the CreatedAfter parameter or the LastUpdatedAfter parameter is required. Both cannot be empty. The date must be in &lt;a href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO 8601&lt;/a&gt; format. (optional)
     * @param string|null $created_before  A date used for selecting orders created before (or at) a specified time. Only orders placed before the specified time are returned. The date must be in &lt;a href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO 8601&lt;/a&gt; format. (optional)
     * @param string|null $last_updated_after  A date used for selecting orders that were last updated after (or at) a specified time. An update is defined as any change in order status, including the creation of a new order. Includes updates made by Amazon and by the seller. The date must be in &lt;a href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO 8601&lt;/a&gt; format. (optional)
     ...
     * @param string[]|null $fulfillment_channels  A list that indicates how an order was fulfilled. Filters the results by fulfillment channel. Possible values: AFN (Fulfillment by Amazon); MFN (Fulfilled by the seller). (optional)
     * @param string[]|null $payment_methods  A list of payment method values. Used to select orders paid using the specified payment methods. Possible values: COD (Cash on delivery); CVS (Convenience store payment); Other (Any payment method other than COD or CVS). (optional)
     ...
     * @param string|null $actual_fulfillment_supply_source_id  Denotes the recommended sourceId where the order should be fulfilled from. (optional)
     ...
     * @param string|null $earliest_delivery_date_before  A date used for selecting orders with a earliest delivery date before (or at) a specified time. The date must be in &lt;a href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO 8601&lt;/a&gt; format. (optional)
     * @param string|null $earliest_delivery_date_after  A date used for selecting orders with a earliest delivery date after (or at) a specified time. The date must be in &lt;a href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO 8601&lt;/a&gt; format. (optional)
     * @param string|null $latest_delivery_date_before  A date used for selecting orders with a latest delivery date before (or at) a specified time. The date must be in &lt;a href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO 8601&lt;/a&gt; format. (optional)
     * @param string|null $latest_delivery_date_after  A date used for selecting orders with a latest delivery date after (or at) a specified time. The date must be in &lt;a href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO 8601&lt;/a&gt; format. (optional)
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException
     ...
     * @return null
     */
    public function updateVerificationStatus(AccessToken $accessToken, string $region, $order_id, $payload)
    {
