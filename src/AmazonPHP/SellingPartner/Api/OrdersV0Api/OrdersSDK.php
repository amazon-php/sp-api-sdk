...
final class OrdersSDK
{
     ...
     */
    public function getOrder($orderId): \AmazonPHP\SellingPartner\Model\Orders\GetOrderResponse
    {
     ...
     */
    private function getOrderWithHttpInfo($orderId) : array
    {
     ...
     */
    private function getOrderRequest($orderId) : RequestInterface
    {
     ...
     */
    public function getOrderAddress($orderId): \AmazonPHP\SellingPartner\Model\Orders\GetOrderAddressResponse
    {
     ...
     */
    private function getOrderAddressWithHttpInfo($orderId) : array
    {
     ...
     * @return RequestInterface
     */
    private function getOrderAddressRequest($orderId) : RequestInterface
    {
        // verify the required parameter 'orderId' is set
        if ($orderId === null || (is_array($orderId) && count($orderId) === 0)) {
            throw new InvalidArgumentException(
     ...
     */
    public function getOrderBuyerInfo($orderId): \AmazonPHP\SellingPartner\Model\Orders\GetOrderBuyerInfoResponse
    {
     ...
     */
    private function getOrderBuyerInfoWithHttpInfo($orderId) : array
    {
     ...
     * @return RequestInterface
     */
    private function getOrderBuyerInfoRequest($orderId) : RequestInterface
    {
        // verify the required parameter 'orderId' is set
        if ($orderId === null || (is_array($orderId) && count($orderId) === 0)) {
            throw new InvalidArgumentException(
     ...
     */
    public function getOrderItems($orderId, $nextToken = null): \AmazonPHP\SellingPartner\Model\Orders\GetOrderItemsResponse
    {
     ...
     */
    private function getOrderItemsWithHttpInfo($orderId, $nextToken = null) : array
    {
     ...
     * @return RequestInterface
     */
    private function getOrderItemsRequest($orderId, $nextToken = null) : RequestInterface
    {
        // verify the required parameter 'orderId' is set
        if ($orderId === null || (is_array($orderId) && count($orderId) === 0)) {
            throw new InvalidArgumentException(
     ...
     */
    public function getOrderItemsBuyerInfo($orderId, $nextToken = null): \AmazonPHP\SellingPartner\Model\Orders\GetOrderItemsBuyerInfoResponse
    {
     ...
     */
    private function getOrderItemsBuyerInfoWithHttpInfo($orderId, $nextToken = null) : array
    {
     ...
     * @return RequestInterface
     */
    private function getOrderItemsBuyerInfoRequest($orderId, $nextToken = null) : RequestInterface
    {
        // verify the required parameter 'orderId' is set
        if ($orderId === null || (is_array($orderId) && count($orderId) === 0)) {
            throw new InvalidArgumentException(
     ...
     */
    public function getOrders($marketplaceIds, $createdAfter = null, $createdBefore = null, $lastUpdatedAfter = null, $lastUpdatedBefore = null, $orderStatuses = null, $fulfillmentChannels = null, $paymentMethods = null, $buyerEmail = null, $sellerOrderId = null, $maxResultsPerPage = null, $easyShipShipmentStatuses = null, $nextToken = null, $amazonOrderIds = null, $actualFulfillmentSupplySourceId = null, $isISPU = null, $storeChainStoreId = null): \AmazonPHP\SellingPartner\Model\Orders\GetOrdersResponse
    {
     ...
     */
    private function getOrdersWithHttpInfo($marketplaceIds, $createdAfter = null, $createdBefore = null, $lastUpdatedAfter = null, $lastUpdatedBefore = null, $orderStatuses = null, $fulfillmentChannels = null, $paymentMethods = null, $buyerEmail = null, $sellerOrderId = null, $maxResultsPerPage = null, $easyShipShipmentStatuses = null, $nextToken = null, $amazonOrderIds = null, $actualFulfillmentSupplySourceId = null, $isISPU = null, $storeChainStoreId = null) : array
    {
     ...
     * @return RequestInterface
     */
    private function getOrdersRequest($marketplaceIds, $createdAfter = null, $createdBefore = null, $lastUpdatedAfter = null, $lastUpdatedBefore = null, $orderStatuses = null, $fulfillmentChannels = null, $paymentMethods = null, $buyerEmail = null, $sellerOrderId = null, $maxResultsPerPage = null, $easyShipShipmentStatuses = null, $nextToken = null, $amazonOrderIds = null, $actualFulfillmentSupplySourceId = null, $isISPU = null, $storeChainStoreId = null) : RequestInterface
    {
