...
final class FBAInventorySDK implements FBAInventorySDKInterface
{
     ...
     * @param bool|null $details  true to return inventory summaries with additional summarized inventory details and quantities. Otherwise, returns inventory summaries only (default value). (optional, default to false)
