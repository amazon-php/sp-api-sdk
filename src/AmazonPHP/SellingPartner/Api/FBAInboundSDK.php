...
final class FBAInboundSDK
{
     ...
     */
    public function getItemEligibilityPreview(AccessToken $accessToken, string $region, string $asin, string $program, $marketplace_ids = null) : \AmazonPHP\SellingPartner\Model\FBAInbound\GetItemEligibilityPreviewResponse
    {
     ...
     */
    public function getItemEligibilityPreviewRequest(AccessToken $accessToken, string $region, string $asin, string $program, $marketplace_ids = null) : RequestInterface
    {
