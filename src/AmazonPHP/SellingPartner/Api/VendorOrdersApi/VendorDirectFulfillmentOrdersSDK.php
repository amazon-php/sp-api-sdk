...
final class VendorDirectFulfillmentOrdersSDK implements VendorDirectFulfillmentOrdersSDKInterface
{
     ...
     * @param bool|null $include_details  When true, returns the complete purchase order details. Otherwise, only purchase order numbers are returned. (optional, default to 'true')
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException
