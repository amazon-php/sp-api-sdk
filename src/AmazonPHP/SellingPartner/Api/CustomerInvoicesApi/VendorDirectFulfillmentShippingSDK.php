...
final class VendorDirectFulfillmentShippingSDK
{
     ...
     */
    public function getCustomerInvoice(AccessToken $accessToken, string $region, string $purchase_order_number) : \AmazonPHP\SellingPartner\Model\VendorDirectFulfillmentShipping\GetCustomerInvoiceResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \AmazonPHP\SellingPartner\Model\VendorDirectFulfillmentShipping\GetCustomerInvoiceResponse::class,
            []
        );
    }
    ...
    public function getCustomerInvoices(AccessToken $accessToken, string $region, \DateTime $created_after, \DateTime $created_before, string $ship_from_party_id = null, int $limit = null, string $sort_order = null, string $next_token = null) : \AmazonPHP\SellingPartner\Model\VendorDirectFulfillmentShipping\GetCustomerInvoicesResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \AmazonPHP\SellingPartner\Model\VendorDirectFulfillmentShipping\GetCustomerInvoicesResponse::class,
            []
        );
    }
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getCustomerInvoicesRequest(AccessToken $accessToken, string $region, \DateTime $created_after, \DateTime $created_before, string $ship_from_party_id = null, int $limit = null, string $sort_order = null, string $next_token = null) : RequestInterface
    {
