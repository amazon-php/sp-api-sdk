 ...
 */
final class FinancialTransfersSDK implements FinancialTransfersSDKInterface
{
    ...
    {
        $request = $this->getPaymentMethodsRequest($accessToken, $region, $marketplace_id, $payment_method_types);

        $this->configuration->extensions()->preRequest('FinancialTransfers', 'getPaymentMethods', $request);
        ...
        try {
            ...
            if ($this->configuration->loggingEnabled('FinancialTransfers', 'getPaymentMethods')) {
                $this->logger->log(
                    $this->configuration->logLevel('FinancialTransfers', 'getPaymentMethods'),
                    'Amazon Selling Partner API pre request',
                    [
                        'api' => 'FinancialTransfers',
                        'operation' => 'getPaymentMethods',
            ...
            $this->configuration->extensions()->postRequest('FinancialTransfers', 'getPaymentMethods', $request, $response);
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonPHP\SellingPartner\Model\Finances\FinancialTransfers\GetPaymentMethodsResponse',
            []
        );
    }
    ...
    public function getPaymentMethodsRequest(AccessToken $accessToken, string $region, string $marketplace_id, ?array $payment_method_types = null) : RequestInterface
    {
        ...
        if ($payment_method_types !== null) {
            $queryParams['paymentMethodTypes'] = ObjectSerializer::toString($payment_method_types);
        }
    ...
    {
        $request = $this->initiatePayoutRequest($accessToken, $region, $body);

        $this->configuration->extensions()->preRequest('FinancialTransfers', 'initiatePayout', $request);
        ...
        try {
            ...
            if ($this->configuration->loggingEnabled('FinancialTransfers', 'initiatePayout')) {
                $this->logger->log(
                    $this->configuration->logLevel('FinancialTransfers', 'initiatePayout'),
                    'Amazon Selling Partner API pre request',
                    [
                        'api' => 'FinancialTransfers',
                        'operation' => 'initiatePayout',
            ...
            $this->configuration->extensions()->postRequest('FinancialTransfers', 'initiatePayout', $request, $response);
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonPHP\SellingPartner\Model\Finances\FinancialTransfers\InitiatePayoutResponse',
            []
        );
    }
