 ...
 */
final class FinancialEventsSDK implements FinancialEventsSDKInterface
{
    ...
    public function listFinancialEventGroups(AccessToken $accessToken, string $region, ?int $max_results_per_page = 10, ?\DateTimeInterface $financial_event_group_started_before = null, ?\DateTimeInterface $financial_event_group_started_after = null, ?string $next_token = null) : \AmazonPHP\SellingPartner\Model\Finances\FinancialEvents\ListFinancialEventGroupsResponse
    {
        ...
        $this->configuration->extensions()->preRequest('FinancialEvents', 'listFinancialEventGroups', $request);
        ...
        try {
            ...
            if ($this->configuration->loggingEnabled('FinancialEvents', 'listFinancialEventGroups')) {
                $this->logger->log(
                    $this->configuration->logLevel('FinancialEvents', 'listFinancialEventGroups'),
            ...
            $this->configuration->extensions()->postRequest('FinancialEvents', 'listFinancialEventGroups', $request, $response);
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonPHP\SellingPartner\Model\Finances\FinancialEvents\ListFinancialEventGroupsResponse',
            []
        );
    }
     ...
     * @throws InvalidArgumentException
     */
    public function listFinancialEvents(AccessToken $accessToken, string $region, ?int $max_results_per_page = 100, ?\DateTimeInterface $posted_after = null, ?\DateTimeInterface $posted_before = null, ?string $next_token = null) : \AmazonPHP\SellingPartner\Model\Finances\FinancialEvents\ListFinancialEventsResponse
    {
        $request = $this->listFinancialEventsRequest($accessToken, $region, $max_results_per_page, $posted_after, $posted_before, $next_token);

        $this->configuration->extensions()->preRequest('FinancialEvents', 'listFinancialEvents', $request);
        ...
        try {
            ...
            if ($this->configuration->loggingEnabled('FinancialEvents', 'listFinancialEvents')) {
                $this->logger->log(
                    $this->configuration->logLevel('FinancialEvents', 'listFinancialEvents'),
                    'Amazon Selling Partner API pre request',
                    [
                        'api' => 'FinancialEvents',
                        'operation' => 'listFinancialEvents',
            ...
            $this->configuration->extensions()->postRequest('FinancialEvents', 'listFinancialEvents', $request, $response);
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonPHP\SellingPartner\Model\Finances\FinancialEvents\ListFinancialEventsResponse',
            []
        );
    }
    ...
    public function listFinancialEventsByGroupId(AccessToken $accessToken, string $region, string $event_group_id, ?int $max_results_per_page = 100, ?\DateTimeInterface $posted_after = null, ?\DateTimeInterface $posted_before = null, ?string $next_token = null) : \AmazonPHP\SellingPartner\Model\Finances\FinancialEvents\ListFinancialEventsResponse
    {
        ...
        $this->configuration->extensions()->preRequest('FinancialEvents', 'listFinancialEventsByGroupId', $request);
        ...
        try {
            ...
            if ($this->configuration->loggingEnabled('FinancialEvents', 'listFinancialEventsByGroupId')) {
                $this->logger->log(
                    $this->configuration->logLevel('FinancialEvents', 'listFinancialEventsByGroupId'),
                    'Amazon Selling Partner API pre request',
                    [
                        'api' => 'FinancialEvents',
                        'operation' => 'listFinancialEventsByGroupId',
            ...
            $this->configuration->extensions()->postRequest('FinancialEvents', 'listFinancialEventsByGroupId', $request, $response);
     ...
     * @throws InvalidArgumentException
     */
    public function listFinancialEventsByOrderId(AccessToken $accessToken, string $region, string $order_id, ?int $max_results_per_page = 100, ?string $next_token = null) : \AmazonPHP\SellingPartner\Model\Finances\FinancialEvents\ListFinancialEventsResponse
    {
        $request = $this->listFinancialEventsByOrderIdRequest($accessToken, $region, $order_id, $max_results_per_page, $next_token);

        $this->configuration->extensions()->preRequest('FinancialEvents', 'listFinancialEventsByOrderId', $request);
        ...
        try {
            ...
            if ($this->configuration->loggingEnabled('FinancialEvents', 'listFinancialEventsByOrderId')) {
                $this->logger->log(
                    $this->configuration->logLevel('FinancialEvents', 'listFinancialEventsByOrderId'),
                    'Amazon Selling Partner API pre request',
                    [
                        'api' => 'FinancialEvents',
                        'operation' => 'listFinancialEventsByOrderId',
            ...
            $this->configuration->extensions()->postRequest('FinancialEvents', 'listFinancialEventsByOrderId', $request, $response);
