...
final class FinancesSDK implements FinancesSDKInterface
{
     ...
     * @param string $region
     * @param int|null $max_results_per_page  The maximum number of results to return per page. If the response exceeds the maximum number of transactions or 10 MB, the API responds with &#39;InvalidInput&#39;. (optional, default to 100)
     ...
     */
    public function listFinancialEventGroupsRequest(AccessToken $accessToken, string $region, $max_results_per_page = 100, $financial_event_group_started_before = null, $financial_event_group_started_after = null, $next_token = null) : RequestInterface
    {
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function listFinancialEventsRequest(AccessToken $accessToken, string $region, $max_results_per_page = 100, $posted_after = null, $posted_before = null, $next_token = null) : RequestInterface
    {
        if ($max_results_per_page !== null && $max_results_per_page > 100) {
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function listFinancialEventsByGroupIdRequest(AccessToken $accessToken, string $region, $event_group_id, $max_results_per_page = 100, $posted_after = null, $posted_before = null, $next_token = null) : RequestInterface
    {
