...
final class AuthorizationSDK implements AuthorizationSDKInterface
{
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getAuthorizationCode(AccessToken $accessToken, string $region, $selling_partner_id, $developer_id, $mws_auth_token) : \AmazonPHP\SellingPartner\Model\Authorization\GetAuthorizationCodeResponse
    {
     ...
     * @throws \AmazonPHP\SellingPartner\Exception\InvalidArgumentException
     */
    public function getAuthorizationCodeRequest(AccessToken $accessToken, string $region, $selling_partner_id, $developer_id, $mws_auth_token) : RequestInterface
    {
