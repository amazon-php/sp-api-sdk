...
final class AuthorizationSDK
{
     ...
     */
    public function getAuthorizationCode($sellingPartnerId, $developerId, $mwsAuthToken): \AmazonPHP\SellingPartner\Model\Authorization\GetAuthorizationCodeResponse
    {
     ...
     */
    private function getAuthorizationCodeWithHttpInfo($sellingPartnerId, $developerId, $mwsAuthToken) : array
    {
     ...
     */
    private function getAuthorizationCodeRequest($sellingPartnerId, $developerId, $mwsAuthToken) : RequestInterface
    {
