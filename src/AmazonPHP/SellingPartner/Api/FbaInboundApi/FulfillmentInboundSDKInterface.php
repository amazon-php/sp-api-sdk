...
interface FulfillmentInboundSDKInterface
{
     ...
     */
    public function confirmPreorder(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id, \DateTimeInterface $need_by_date, string $marketplace_id);
     ...
     */
    public function confirmPreorderRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id, \DateTimeInterface $need_by_date, string $marketplace_id) : \Psr\Http\Message\RequestInterface;
     ...
     */
    public function confirmTransport(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id);
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function confirmTransportRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id) : \Psr\Http\Message\RequestInterface;
     ...
     */
    public function createInboundShipment(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id, \AmazonPHP\SellingPartner\Model\FulfillmentInbound\InboundShipmentRequest $body);
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function createInboundShipmentRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id, \AmazonPHP\SellingPartner\Model\FulfillmentInbound\InboundShipmentRequest $body) : \Psr\Http\Message\RequestInterface;
     ...
     */
    public function createInboundShipmentPlan(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, \AmazonPHP\SellingPartner\Model\FulfillmentInbound\CreateInboundShipmentPlanRequest $body);
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function createInboundShipmentPlanRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, \AmazonPHP\SellingPartner\Model\FulfillmentInbound\CreateInboundShipmentPlanRequest $body) : \Psr\Http\Message\RequestInterface;
     ...
     */
    public function estimateTransport(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id);
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function estimateTransportRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id) : \Psr\Http\Message\RequestInterface;
     ...
     */
    public function getBillOfLading(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id);
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function getBillOfLadingRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id) : \Psr\Http\Message\RequestInterface;
     ...
     */
    public function getInboundGuidance(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $marketplace_id, array $seller_sku_list = null, array $asin_list = null);
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function getInboundGuidanceRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $marketplace_id, array $seller_sku_list = null, array $asin_list = null) : \Psr\Http\Message\RequestInterface;
     ...
     */
    public function getLabels(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id, string $page_type, string $label_type, int $number_of_packages = null, array $package_labels_to_print = null, int $number_of_pallets = null, int $page_size = null, int $page_start_index = null);
     ...
     */
    public function getPreorderInfo(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id, string $marketplace_id);
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function getPreorderInfoRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id, string $marketplace_id) : \Psr\Http\Message\RequestInterface;
     ...
     */
    public function getPrepInstructions(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $ship_to_country_code, array $seller_sku_list = null, array $asin_list = null);
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function getPrepInstructionsRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $ship_to_country_code, array $seller_sku_list = null, array $asin_list = null) : \Psr\Http\Message\RequestInterface;
     ...
     */
    public function getShipmentItems(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $query_type, string $marketplace_id, \DateTimeInterface $last_updated_after = null, \DateTimeInterface $last_updated_before = null, string $next_token = null);
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function getShipmentItemsRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $query_type, string $marketplace_id, \DateTimeInterface $last_updated_after = null, \DateTimeInterface $last_updated_before = null, string $next_token = null) : \Psr\Http\Message\RequestInterface;
     ...
     * @return \AmazonPHP\SellingPartner\Model\FulfillmentInbound\GetShipmentItemsResponse
     */
    public function getShipmentItemsByShipmentId(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id, string $marketplace_id);
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function getShipmentItemsByShipmentIdRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id, string $marketplace_id) : \Psr\Http\Message\RequestInterface;
     ...
     */
    public function getShipments(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $query_type, string $marketplace_id, array $shipment_status_list = null, array $shipment_id_list = null, \DateTimeInterface $last_updated_after = null, \DateTimeInterface $last_updated_before = null, string $next_token = null);
     ...
     */
    public function getTransportDetails(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id);
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function getTransportDetailsRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id) : \Psr\Http\Message\RequestInterface;
     ...
     */
    public function putTransportDetails(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id, \AmazonPHP\SellingPartner\Model\FulfillmentInbound\PutTransportDetailsRequest $body);
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function putTransportDetailsRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id, \AmazonPHP\SellingPartner\Model\FulfillmentInbound\PutTransportDetailsRequest $body) : \Psr\Http\Message\RequestInterface;
     ...
     * @return \AmazonPHP\SellingPartner\Model\FulfillmentInbound\InboundShipmentResponse
     */
    public function updateInboundShipment(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id, \AmazonPHP\SellingPartner\Model\FulfillmentInbound\InboundShipmentRequest $body);
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function updateInboundShipmentRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id, \AmazonPHP\SellingPartner\Model\FulfillmentInbound\InboundShipmentRequest $body) : \Psr\Http\Message\RequestInterface;
     ...
     */
    public function voidTransport(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id);
     ...
     * @return \Psr\Http\Message\RequestInterface
     */
    public function voidTransportRequest(\AmazonPHP\SellingPartner\AccessToken $accessToken, string $region, string $shipment_id) : \Psr\Http\Message\RequestInterface;
}
