 ...
 */
class SearchContentPublishRecordsResponseAllOf implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    public function validate() : void
    {
        if ($this->container['publish_record_list'] === null) {
            throw new AssertionException("'publish_record_list' can't be null");
        }
    }
