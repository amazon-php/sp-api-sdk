 ...
 */
class AplusPaginatedResponseAllOf implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AplusPaginatedResponse_allOf';
