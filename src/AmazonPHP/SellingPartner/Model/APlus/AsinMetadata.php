 ...
 */
class AsinMetadata implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    public function validate() : void
    {
        ...
        if (null !== $this->container['parent'] && (\mb_strlen((string) $this->container['parent']) < 10)) {
        ...
        if (null !== $this->container['image_url'] && (\mb_strlen((string) $this->container['image_url']) < 1)) {
