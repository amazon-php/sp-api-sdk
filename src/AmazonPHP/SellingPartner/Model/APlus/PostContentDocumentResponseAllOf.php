 ...
 */
class PostContentDocumentResponseAllOf implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'PostContentDocumentResponse_allOf';
