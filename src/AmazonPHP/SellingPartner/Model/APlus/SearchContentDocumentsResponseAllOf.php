 ...
 */
class SearchContentDocumentsResponseAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @return self
     */
    public function setContentMetadataRecords($contentMetadataRecords) : self
    {
