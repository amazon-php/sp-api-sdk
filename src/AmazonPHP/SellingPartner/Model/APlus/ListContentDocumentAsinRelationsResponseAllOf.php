 ...
 */
class ListContentDocumentAsinRelationsResponseAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @return self
     */
    public function setAsinMetadataSet($asin_metadata_set) : self
    {
