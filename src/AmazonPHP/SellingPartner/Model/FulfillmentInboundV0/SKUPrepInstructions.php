...
class SKUPrepInstructions implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'seller_sku' => 'string',
        'asin' => 'string',
        'barcode_instruction' => '\AmazonPHP\SellingPartner\Model\FulfillmentInboundV0\BarcodeInstruction',
        'prep_guidance' => '\AmazonPHP\SellingPartner\Model\FulfillmentInboundV0\PrepGuidance',
        'prep_instruction_list' => '\AmazonPHP\SellingPartner\Model\FulfillmentInboundV0\PrepInstruction[]',
        'amazon_prep_fees_details_list' => '\AmazonPHP\SellingPartner\Model\FulfillmentInboundV0\AmazonPrepFeesDetails[]',
    ];
