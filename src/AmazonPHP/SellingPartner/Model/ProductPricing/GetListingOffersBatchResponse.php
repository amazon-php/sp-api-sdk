 ...
 */
class GetListingOffersBatchResponse implements \ArrayAccess, \JsonSerializable, ModelInterface
{
    ...
    {
        if (null !== $responses && (\count($responses) > 20)) {
        ...
        if (null !== $responses && (\count($responses) < 1)) {
