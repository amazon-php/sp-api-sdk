 ...
 */
class GetOffersResponse implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * Sets payload.
     *
     * @param null|\AmazonPHP\SellingPartner\Model\ProductPricing\GetOffersResult $payload payload
     */
