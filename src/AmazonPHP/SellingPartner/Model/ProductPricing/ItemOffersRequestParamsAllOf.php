 ...
 */
class ItemOffersRequestParamsAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ItemOffersRequestParams_allOf';
