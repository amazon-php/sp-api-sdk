...
class GetItemOffersBatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets requests
     *
     * @return \AmazonPHP\SellingPartner\Model\ProductPricing\ItemOffersRequest[]|null
     */
     ...
     * Sets requests
     *
     * @param \AmazonPHP\SellingPartner\Model\ProductPricing\ItemOffersRequest[]|null $requests A list of `getListingOffers` batched requests to run.
     *
     * @return self
     */
