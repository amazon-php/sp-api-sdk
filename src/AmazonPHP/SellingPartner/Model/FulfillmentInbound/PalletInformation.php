...
class PalletInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets pallets
     *
     * @return \AmazonPHP\SellingPartner\Model\FulfillmentInbound\PalletInput[]
     */
     ...
     * Sets pallets
     *
     * @param \AmazonPHP\SellingPartner\Model\FulfillmentInbound\PalletInput[] $pallets Set pallet configuration for Less-Than-Truckload (LTL).
     *
     * @return self
     */
