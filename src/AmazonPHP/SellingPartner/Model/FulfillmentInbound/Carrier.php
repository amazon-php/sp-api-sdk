 ...
 */
class Carrier implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    {
        $this->container['alpha_code'] = $data['alpha_code'] ?? null;
    ...
    {
        if (null !== $this->container['alpha_code'] && (\mb_strlen((string) $this->container['alpha_code']) > 1024)) {
            throw new AssertionException("invalid value for 'alpha_code', the character length must be smaller than or equal to 1024.");
        }

        if (null !== $this->container['alpha_code'] && (\mb_strlen((string) $this->container['alpha_code']) < 1)) {
            throw new AssertionException("invalid value for 'alpha_code', the character length must be bigger than or equal to 1.");
        }

        if (null !== $this->container['name'] && (\mb_strlen((string) $this->container['name']) > 1024)) {
