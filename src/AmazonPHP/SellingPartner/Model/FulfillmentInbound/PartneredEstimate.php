...
class PartneredEstimate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param \DateTimeInterface|null $confirm_deadline Timestamp in ISO 8601 format.
     *
     * @return self
     */
    public function setConfirmDeadline($confirm_deadline) : self
    {
     ...
     * Sets void_deadline
     *
     * @param \DateTimeInterface|null $void_deadline Timestamp in ISO 8601 format.
     *
     * @return self
     */
    public function setVoidDeadline($void_deadline) : self
    {
