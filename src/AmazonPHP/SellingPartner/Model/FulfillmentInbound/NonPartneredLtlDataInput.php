 ...
 */
class NonPartneredLtlDataInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'NonPartneredLtlDataInput';
