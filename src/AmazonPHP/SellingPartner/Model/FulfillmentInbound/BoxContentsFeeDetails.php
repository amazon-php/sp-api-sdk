...
class BoxContentsFeeDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @return self
     */
    public function setTotalUnits($total_units) : self
    {
     ...
     * Sets total_fee
     *
     * @param \AmazonPHP\SellingPartner\Model\FulfillmentInbound\Amount|null $total_fee total_fee
     *
     * @return self
     */
    public function setTotalFee($total_fee) : self
    {
