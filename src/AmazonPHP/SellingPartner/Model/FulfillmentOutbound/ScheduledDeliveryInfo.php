 ...
 */
class ScheduledDeliveryInfo implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     *
     * @param DeliveryWindow[] $delivery_windows an array of delivery windows
     */
