 ...
 */
class GetDeliveryOffersRequest implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'product' => '\AmazonPHP\SellingPartner\Model\FulfillmentOutbound\GetDeliveryOffersProduct',
        'terms' => '\AmazonPHP\SellingPartner\Model\FulfillmentOutbound\GetDeliveryOffersTerms',
    ];
    ...
    public function validate() : void
    {
        ...
        if ($this->container['terms'] === null) {
            throw new AssertionException("'terms' can't be null");
        }

        $this->container['terms']->validate();
    }
