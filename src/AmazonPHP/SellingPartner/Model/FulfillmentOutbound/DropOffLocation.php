 ...
 */
class DropOffLocation implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    final public const DISCRIMINATOR = null;

    final public const TYPE_FRONT_DOOR = 'FRONT_DOOR';

    final public const TYPE_DELIVERY_BOX = 'DELIVERY_BOX';

    final public const TYPE_GAS_METER_BOX = 'GAS_METER_BOX';

    final public const TYPE_BICYCLE_BASKET = 'BICYCLE_BASKET';

    final public const TYPE_GARAGE = 'GARAGE';

    final public const TYPE_RECEPTIONIST = 'RECEPTIONIST';

    final public const TYPE_FALLBACK_NEIGHBOR_DELIVERY = 'FALLBACK_NEIGHBOR_DELIVERY';

    final public const TYPE_DO_NOT_LEAVE_UNATTENDED = 'DO_NOT_LEAVE_UNATTENDED';
