...
class AccessibilityAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets distance
     *
     * @param string|null $distance The approximate distance of access point from input postalCode's centroid.
     *
     * @return self
     */
     ...
     * Sets drive_time
     *
     * @param int|null $drive_time The approximate (static) drive time from input postal code's centroid.
     *
     * @return self
     */
    public function setDriveTime($drive_time) : self
    {
