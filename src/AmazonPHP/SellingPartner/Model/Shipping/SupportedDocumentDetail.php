...
class SupportedDocumentDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'name' => '\AmazonPHP\SellingPartner\Model\Shipping\DocumentType',
        'is_mandatory' => 'bool'
    ];
    ...
    public function validate() : void
    {
        ...
        if ($this->container['is_mandatory'] === null) {
            throw new AssertionException("'is_mandatory' can't be null");
        }
     ...
     * Sets name
     *
     * @param \AmazonPHP\SellingPartner\Model\Shipping\DocumentType $name name
     *
     * @return self
     */
