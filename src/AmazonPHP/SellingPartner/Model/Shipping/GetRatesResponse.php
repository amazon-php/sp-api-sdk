 ...
 */
class GetRatesResponse implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * Sets payload.
     *
     * @param null|\AmazonPHP\SellingPartner\Model\Shipping\GetRatesResult $payload payload
     */
