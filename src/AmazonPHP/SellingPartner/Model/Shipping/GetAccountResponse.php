 ...
 */
class GetAccountResponse implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * Sets payload.
     *
     * @param null|\AmazonPHP\SellingPartner\Model\Shipping\Account $payload payload
     */
