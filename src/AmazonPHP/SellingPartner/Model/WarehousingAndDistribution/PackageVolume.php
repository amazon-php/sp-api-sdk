 ...
 */
class PackageVolume implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'unit_of_measurement' => '\AmazonPHP\SellingPartner\Model\WarehousingAndDistribution\VolumeUnitOfMeasurement',
        'volume' => 'float',
    ];
    ...
    public function validate() : void
    {
        ...
        if ($this->container['volume'] === null) {
            throw new AssertionException("'volume' can't be null");
        }
    }
     ...
     *
     * @return \AmazonPHP\SellingPartner\Model\WarehousingAndDistribution\VolumeUnitOfMeasurement
     */
    public function getUnitOfMeasurement() : VolumeUnitOfMeasurement
    {
