 ...
 */
class InventoryListing implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'inventory' => '\AmazonPHP\SellingPartner\Model\WarehousingAndDistribution\InventorySummary[]',
        'next_token' => 'string',
    ];
    ...
    public function validate() : void
    {
        if ($this->container['inventory'] === null) {
            throw new AssertionException("'inventory' can't be null");
        }
    }
     ...
     * Sets next_token.
     *
     * @param null|string $next_token token to retrieve the next set of paginated results
     */
