 ...
 */
class ShipmentListing implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'next_token' => 'string',
        'shipments' => '\AmazonPHP\SellingPartner\Model\WarehousingAndDistribution\InboundShipmentSummary[]',
    ];
