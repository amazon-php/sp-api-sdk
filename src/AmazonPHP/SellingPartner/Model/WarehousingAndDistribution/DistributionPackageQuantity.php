 ...
 */
class DistributionPackageQuantity implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'count' => 'int',
        'distribution_package' => '\AmazonPHP\SellingPartner\Model\WarehousingAndDistribution\DistributionPackage',
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['distribution_package'] = $data['distribution_package'] ?? null;
    }
    ...
    public function validate() : void
    {
        ...
        if ($this->container['distribution_package'] === null) {
            throw new AssertionException("'distribution_package' can't be null");
        }

        $this->container['distribution_package']->validate();
    }
