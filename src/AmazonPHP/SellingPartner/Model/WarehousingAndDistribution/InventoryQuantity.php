 ...
 */
class InventoryQuantity implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'quantity' => 'float',
        'unit_of_measurement' => '\AmazonPHP\SellingPartner\Model\WarehousingAndDistribution\InventoryUnitOfMeasurement',
    ];
