...
class OrderedQuantityDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets updated_date
     *
     * @param \DateTimeInterface|null $updated_date The date when the line item quantity was updated by buyer. Must be in ISO-8601 date/time format.
     *
     * @return self
     */
     ...
     *
     * @param \AmazonPHP\SellingPartner\Model\VendorOrders\ItemQuantity|null $cancelled_quantity cancelled_quantity
     *
     * @return self
     */
