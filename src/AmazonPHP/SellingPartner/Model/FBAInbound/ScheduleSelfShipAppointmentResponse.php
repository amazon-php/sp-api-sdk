...
class ScheduleSelfShipAppointmentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function validate() : void
    {
        if ($this->container['self_ship_appointment_details'] === null) {
            throw new AssertionException("'self_ship_appointment_details' can't be null");
        }

            $this->container['self_ship_appointment_details']->validate();
     ...
     *
     * @return \AmazonPHP\SellingPartner\Model\FBAInbound\SelfShipAppointmentDetails
     */
     ...
     *
     * @param \AmazonPHP\SellingPartner\Model\FBAInbound\SelfShipAppointmentDetails $self_ship_appointment_details self_ship_appointment_details
     *
     * @return self
     */
