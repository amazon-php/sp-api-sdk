...
class InboundPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'name' => 'string',
        'packing_options' => '\AmazonPHP\SellingPartner\Model\FBAInbound\PackingOptionSummary[]',
        'placement_options' => '\AmazonPHP\SellingPartner\Model\FBAInbound\PlacementOptionSummary[]',
        'shipments' => '\AmazonPHP\SellingPartner\Model\FBAInbound\ShipmentSummary[]',
     ...
     *
     * @return \AmazonPHP\SellingPartner\Model\FBAInbound\PackingOptionSummary[]|null
     */
     ...
     *
     * @param \AmazonPHP\SellingPartner\Model\FBAInbound\PackingOptionSummary[]|null $packing_options Packing options for the inbound plan. This property will be populated when it has been generated via the corresponding endpoint. If there is a chosen placement option, only packing options for that placement option will be returned. If there are confirmed shipments, only packing options for those shipments will be returned. Query the packing option for more details.
     *
     * @return self
     */
     ...
     *
     * @return \AmazonPHP\SellingPartner\Model\FBAInbound\PlacementOptionSummary[]|null
     */
     ...
     *
     * @param \AmazonPHP\SellingPartner\Model\FBAInbound\PlacementOptionSummary[]|null $placement_options Placement options for the inbound plan. This property will be populated when it has been generated via the corresponding endpoint. If there is a chosen placement option, that will be the only returned option. Query the placement option for more details.
     *
     * @return self
     */
     ...
     * Gets shipments
     *
     * @return \AmazonPHP\SellingPartner\Model\FBAInbound\ShipmentSummary[]|null
     */
     ...
     * Sets shipments
     *
     * @param \AmazonPHP\SellingPartner\Model\FBAInbound\ShipmentSummary[]|null $shipments Shipment IDs for the inbound plan. This property will be populated when it has been generated via the corresponding endpoint. If there is a chosen placement option, only shipments for that option will be returned. If there are confirmed shipments, only those shipments will be returned. Query the shipment for more details.
     *
     * @return self
     */
