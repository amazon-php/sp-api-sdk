 ...
 */
class UpdateShipmentDeliveryWindowResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UpdateShipmentDeliveryWindowResponse';
