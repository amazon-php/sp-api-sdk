 ...
 */
class CreateReportScheduleResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CreateReportScheduleResult';
