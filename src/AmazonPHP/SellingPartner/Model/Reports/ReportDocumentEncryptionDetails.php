 ...
 */
class ReportDocumentEncryptionDetails implements \ArrayAccess, \JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ReportDocumentEncryptionDetails';
