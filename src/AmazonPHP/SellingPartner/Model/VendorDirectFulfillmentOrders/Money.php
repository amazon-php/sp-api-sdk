...
class Money implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * Sets amount.
     *
     * @param null|string $amount A decimal number with no loss of precision. Useful when precision loss is unacceptable, as with currencies. Follows RFC7159 for number representation.
     */
