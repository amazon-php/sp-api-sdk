 ...
 */
class CreateDigitalAccessKeyRequest implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * Sets attachments.
     *
     * @param null|Attachment[] $attachments attachments that you want to include in the message to the buyer
     */
