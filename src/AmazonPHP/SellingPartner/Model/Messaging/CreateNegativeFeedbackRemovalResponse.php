 ...
 */
class CreateNegativeFeedbackRemovalResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CreateNegativeFeedbackRemovalResponse';
