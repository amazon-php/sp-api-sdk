 ...
 */
class CreateConfirmCustomizationDetailsRequest implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    {
        if (null !== $this->container['text'] && (\mb_strlen((string) $this->container['text']) > 800)) {
