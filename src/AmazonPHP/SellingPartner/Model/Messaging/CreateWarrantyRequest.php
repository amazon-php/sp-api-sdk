...
class CreateWarrantyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param \DateTimeInterface|null $coverage_start_date The start date of the warranty coverage to include in the message to the buyer.
     *
     * @return self
     */
    public function setCoverageStartDate($coverage_start_date) : self
    {
     ...
     *
     * @param \DateTimeInterface|null $coverage_end_date The end date of the warranty coverage to include in the message to the buyer.
     *
     * @return self
     */
    public function setCoverageEndDate($coverage_end_date) : self
    {
