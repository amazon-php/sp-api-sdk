 ...
 */
class ContainerLabel implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        ...
        'content' => 'string',
        'format' => '\AmazonPHP\SellingPartner\Model\VendorDirectFulfillmentShipping\ContainerLabelFormat',
    ];
    ...
    /**
     * Gets container_tracking_number.
     */
    ...
    /**
     * Sets container_tracking_number.
     *
     * @param null|string $container_tracking_number the container (pallet) tracking identifier from the shipping carrier
     */
     ...
     * Gets format.
     */
    public function getFormat() : ContainerLabelFormat
    {
