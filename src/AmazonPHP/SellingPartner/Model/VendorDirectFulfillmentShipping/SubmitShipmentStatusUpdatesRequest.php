 ...
 */
class SubmitShipmentStatusUpdatesRequest implements \ArrayAccess, \JsonSerializable, ModelInterface
{
    ...
    {
        if (null !== $shipment_status_updates && (\count($shipment_status_updates) < 1)) {
