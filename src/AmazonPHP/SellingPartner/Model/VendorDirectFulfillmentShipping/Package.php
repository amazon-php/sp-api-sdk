...
class Package implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    {
        $this->container['package_tracking_number'] = $data['package_tracking_number'] ?? null;
    }
     ...
     *
     * @param string $package_tracking_number The tracking number on the label of shipment package, that you can fetch from the `shippingLabels` response. You can also scan the bar code on the shipping label to get the tracking number.
     */
    public function setPackageTrackingNumber(string $package_tracking_number) : self
    {
