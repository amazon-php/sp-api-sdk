 ...
 */
class CreateContainerLabelResponse implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'container_label' => '\AmazonPHP\SellingPartner\Model\VendorDirectFulfillmentShipping\ContainerLabel',
    ];
    ...
    public function validate() : void
    {
        ...
        $this->container['container_label']->validate();
    }

    /**
     * Gets container_label.
     */
    public function getContainerLabel() : ContainerLabel
    {
    ...
    {
        $this->container['container_label'] = $container_label;
