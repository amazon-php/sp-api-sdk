...
class UpdateShipmentStatusRequest implements \ArrayAccess, \JsonSerializable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        ...
        'order_items' => '\AmazonPHP\SellingPartner\Model\Orders\OrderItemsInner[]',
    ];
     ...
     * Sets order_items.
     *
     * @param null|\AmazonPHP\SellingPartner\Model\Orders\OrderItemsInner[] $order_items the list of order items and quantities when the seller wants to partially update the shipment status of the order
     */
