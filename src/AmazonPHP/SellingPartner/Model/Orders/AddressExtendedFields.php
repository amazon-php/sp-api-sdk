...
class AddressExtendedFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets street_number
     *
     * @param string|null $street_number The house number/building number/property number in the street.
     *
     * @return self
     */
     ...
     * Sets neighborhood
     *
     * @param string|null $neighborhood The neighborhood. It's smaller than a region and an integral part of an address. It is used in some countries like Brazil.
     *
     * @return self
     */
