 ...
 */
class ItemApprovalActionChanges implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ItemApprovalAction_Changes';
    ...
    protected static array $openAPITypes = [
        ...
        'quantity' => 'int',
        'substituted_by' => '\AmazonPHP\SellingPartner\Model\Orders\ItemIdentifier',
    ];
    ...
    public function validate() : void
    {
        ...
        if ($this->container['substituted_by'] !== null) {
            $this->container['substituted_by']->validate();
        }
    }
     ...
     * Sets quantity.
     *
     * @param null|int $quantity Quantity approved. If substitutedBy is specified, this value applies to the substitution item.
     */
     ...
     * Sets substituted_by.
     *
     * @param null|\AmazonPHP\SellingPartner\Model\Orders\ItemIdentifier $substituted_by substituted_by
     */
    public function setSubstitutedBy(?ItemIdentifier $substituted_by) : self
    {
