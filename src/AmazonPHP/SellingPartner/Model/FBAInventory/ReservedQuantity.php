...
class ReservedQuantity implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @return self
     */
    public function setTotalReservedQuantity($totalReservedQuantity) : self
    {
     ...
     * @return self
     */
    public function setPendingCustomerOrderQuantity($pendingCustomerOrderQuantity) : self
    {
     ...
     * @return self
     */
    public function setPendingTransshipmentQuantity($pendingTransshipmentQuantity) : self
    {
     ...
     * @return self
     */
    public function setFcProcessingQuantity($fcProcessingQuantity) : self
    {
