 ...
 */
class GetInventorySummariesResult implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     *
     * @param InventorySummary[] $inventory_summaries a list of inventory summaries
     */
