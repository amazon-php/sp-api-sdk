...
class CreateRestrictedDataTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $restrictedDataToken A Restricted Data Token (RDT). This is a short-lived access token that authorizes you to access the restricted resources that you specified. Pass this value with the x-amzn-access-token header when making subsequent calls to these restricted resources.
     *
     * @return self
     */
    public function setRestrictedDataToken($restrictedDataToken) : self
    {
