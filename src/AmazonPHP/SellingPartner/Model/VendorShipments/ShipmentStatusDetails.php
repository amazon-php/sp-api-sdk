 ...
 */
class ShipmentStatusDetails implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    final public const DISCRIMINATOR = null;

    final public const SHIPMENT_STATUS_CREATED = 'Created';

    final public const SHIPMENT_STATUS_TRANSPORTATION_REQUESTED = 'TransportationRequested';

    final public const SHIPMENT_STATUS_CARRIER_ASSIGNED = 'CarrierAssigned';
    ...
    protected static array $openAPITypes = [
        ...
        'shipment_status_date' => '\DateTimeInterface',
    ];
     ...
     *
     * @param null|string $shipment_status current status of the shipment on whether it is picked up or scheduled
     */
