 ...
 */
class CartonReferenceDetails implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * Sets carton_count.
     *
     * @param null|int $carton_count pallet level carton count is mandatory for single item pallet and optional for mixed item pallet
     */
