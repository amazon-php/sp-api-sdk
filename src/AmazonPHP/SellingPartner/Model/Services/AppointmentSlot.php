...
class AppointmentSlot implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets start_time
     *
     * @param \DateTimeInterface|null $start_time Time window start time in ISO 8601 format.
     *
     * @return self
     */
     ...
     * Sets end_time
     *
     * @param \DateTimeInterface|null $end_time Time window end time in ISO 8601 format.
     *
     * @return self
     */
