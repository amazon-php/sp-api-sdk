 ...
 */
class ListFinancialEventsPayload implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'next_token' => 'string',
        'financial_events' => '\AmazonPHP\SellingPartner\Model\Finances\FinancialEvents\FinancialEvents',
    ];
