 ...
 */
class ListFinancialEventGroupsPayload implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'next_token' => 'string',
        'financial_event_group_list' => '\AmazonPHP\SellingPartner\Model\Finances\FinancialEvents\FinancialEventGroup[]',
    ];
