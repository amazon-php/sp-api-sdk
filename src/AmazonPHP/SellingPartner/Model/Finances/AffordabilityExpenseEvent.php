...
class AffordabilityExpenseEvent implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * Sets marketplace_id.
     *
     * @param null|string $marketplace_id the Amazon-defined marketplace identifier
     */
     ...
     *
     * @param null|string $transaction_type The type of transaction.   Possible values:  * `Charge`: an affordability promotion expense. * `Refund`: an affordability promotion expense reversal.
     */
