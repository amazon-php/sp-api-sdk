 ...
 */
class ValueAddedServiceChargeEventList implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ValueAddedServiceChargeEventList';
