...
class Breakdown implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        ...
        'breakdown_amount' => '\AmazonPHP\SellingPartner\Model\Finances\FinancialTransactions\Currency',
    ...
    {
        if ($this->container['breakdown_amount'] !== null) {
            $this->container['breakdown_amount']->validate();
        }

        if ($this->container['breakdowns'] !== null) {
            $this->container['breakdowns']->validate();
        }
    }
