...
class Categories implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Categories';
     ...
     * @return self
     */
    public function setProductCategoryId($productCategoryId) : self
    {
     ...
     * @return self
     */
    public function setProductCategoryName($productCategoryName) : self
    {
