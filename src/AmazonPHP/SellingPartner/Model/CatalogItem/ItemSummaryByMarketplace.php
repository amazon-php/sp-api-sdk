...
class ItemSummaryByMarketplace implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @return self
     */
    public function setBrowseNode($browse_node) : self
    {
     ...
     * @return self
     */
    public function setColorName($color_name) : self
    {
     ...
     * @return self
     */
    public function setSizeName($size_name) : self
    {
     ...
     * @return self
     */
    public function setStyleName($style_name) : self
    {
