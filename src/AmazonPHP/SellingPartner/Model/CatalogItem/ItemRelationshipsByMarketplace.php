 ...
 */
class ItemRelationshipsByMarketplace implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    public function validate() : void
    {
        ...
        if ($this->container['relationships'] === null) {
            throw new AssertionException("'relationships' can't be null");
        }
    }
     ...
     * Gets relationships.
     *
     * @return \AmazonPHP\SellingPartner\Model\CatalogItem\ItemRelationship[]
     */
     ...
     * Sets relationships.
     *
     * @param \AmazonPHP\SellingPartner\Model\CatalogItem\ItemRelationship[] $relationships relationships for the item
     */
